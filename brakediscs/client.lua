...
TriggerEvent('chat:addSuggestion', '/yanandisc', 'Isınıan diskleri aç/kapat.', {})
RegisterCommand("yanandisc", function()
	if(enabled == 1) then
		enabled = 0
		TriggerEvent("chatMessage", "Bot", {255, 255, 255}, "^*Isınan disk animasyonu kapatıldı.")
	else
		enabled = 1
		TriggerEvent("chatMessage", "Bot", {255, 255, 255}, "^*Isınan disk animasyonu açıldı.")
	end
end)
